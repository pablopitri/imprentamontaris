...
@section('content')
	<div class="relative">
		<div class="row">
      <div class="col-xs-12">
          <h1 class="page-head-line">ORDENES DE TRABAJO</h1>
      </div>
	  </div>
	  ...
	  <div class="float">
        ...
        <tr>
          <td>
            <a href="{{ url('/ordenes') }}" id="back" class="btn btn-default btn-lg margin-r hidden">
              <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>
              REGRESAR
            </a>
          </td>
          <td>
          	<a href="{{ url('/ordenes/create') }}" class="btn btn-primary btn-lg">
					...
					<div class="panel-body">
						<table class="max-width">
							<tr>
								...
								<td><input type="text" class="solo-numero" name="search-id" id="search-id" data-n='search'></td>
								<td><label class="control-label" for="search-fecha_inicio">FECHA INICIO</label></td>
								<td><input type="text" class="datepicker" name="search-fecha_inicio" id="search-fecha_inicio" data-n='search'></td>
								<td><label class="control-label" for="search-fecha_final">FECHA FINAL</label></td>
								<td><input type="text" class="datepicker" name="search-fecha_final" id="search-fecha_final" data-n='search'></td>
								<td><label class="control-label" for="search-pendientes">PENDIENTES</label></td>
								<td>
									<table>
										<tr>
											<td>
												<input type="checkbox" name="search-pendientes" id="search-pendientes" data-n='search' value="" class="margin-r">
											</td>
											<td width="20px"></td>
											<td>
												<button class="btn btn-default" id="buscar-ordenes" data-w="1">
									...
									<tr>
										...
										<td style="width: 100px">
											<table>
												<tr>
													<td>
														<a href="{{ url('/ordenes/'.$orden->id.'/edit') }}" class="btn btn-warning btn-sm margin-r">
															<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
															Editar
														</a>
													</td>
													<td>
														@include('ordenes.delete', ['orden' => $orden, 'class' => 'btn btn-sm btn-danger'])
													</td>
												</tr>
											</table>
										</td>
